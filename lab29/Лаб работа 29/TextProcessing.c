...
//
//
//char filenameDict[] = "dict0b.txt";
////char filenameIn[] = "text1.txt";
////char filenameOut[] = "text1_out.html";
////
////char filenameIn[] = "Alice.txt";
////char filenameOut[] = "Alice_out.html";
//
//char filenameIn[] = "Tolkien.txt";
//char filenameOut[] = "Tolkien_out.html";
//
//void main() {
